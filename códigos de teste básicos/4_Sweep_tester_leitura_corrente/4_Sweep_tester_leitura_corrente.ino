...
void loop() {
  ...
  if (millis() - lastMillis > 100) {
    lastMillis = millis();
    uint16_t leitura_analogica = analogRead(SINAL_SHUNT);
    float tensao = leitura_analogica / 1240.9;
    float tensao_shunt = tensao / 22;
    float corrente = tensao_shunt * 10;
